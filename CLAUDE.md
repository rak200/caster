...
Nothing pending. The former **Fluent API** idea migrated to the devr proposal process as RFC 0015 (`rak200/fluent-utils` — devr's `docs/proposals/0015-fluent-utils.md`); caster's surface is unaffected — the fluent package would consume caster's public API as a regular dependency.
