...
final class CasterToNumberTest extends TestCase {
    ...
    public function testStringable(): void {
        $obj = new class implements Stringable {
            public function __toString(): string { return '7.7'; }
        };
    ...
    public function testToNumber(): void {
        $obj = new class implements ToNumber {
            public function toNumber(): Number { return new Number('2.71'); }
        };
    ...
    public function testToInt(): void {
        $obj = new class implements ToInt {
            public function toInt(): int { return 9; }
        };
    ...
    public function testToFloat(): void {
        $obj = new class implements ToFloat {
            public function toFloat(): float { return 0.5; }
        };
    ...
    public function testToEnum(): void {
        $obj = new class implements ToEnum {
            public function toEnum(): BackedEnum { return CasterToNumberTestLevel::High; }
        };
