...
[![License: MIT](https://img.shields.io/badge/license-Apache-blue)](LICENSE)
...
- Runtime dependency: [`rak200/utils`](https://github.com/rak200/utils) `^4.4` (installed automatically).
